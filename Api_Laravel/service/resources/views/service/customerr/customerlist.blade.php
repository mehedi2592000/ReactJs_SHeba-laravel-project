...
<!--        <td>{{$customerlist->status}}</td> -->
        ...
        <td><a class="btn btn-success px-3" href="/customerupdate/{{$customerlist->id}}/{{$customerlist->name}}">update</a></td>

        <td><a class="btn btn-danger px-3" href="/customerDelete/{{$customerlist->id}}/{{$customerlist->name}}">Delete</a></td>
